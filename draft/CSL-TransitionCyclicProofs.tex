...
Using the construction specified in Definition \ref{def:preProofTrans}, and the Definitions \ref{def:TracePath} and \ref{def:traceCyclic} of path and traces for transition graphs and cyclic pre-proofs, it can be deduced that:
