...
Given a transition graph $\mathcal{G}$ we define its {\em transitive closure} as the graph $\mathcal{G}^* = (V, \mathcal{B}^*, E^*)$, where
$\mathcal{B}^*$ is the closure of $\mathcal{B}$ under composition of bi-colored relations and $E^* \subseteq V \times \mathcal{B}^* \times V$
