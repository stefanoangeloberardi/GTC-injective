...
\end{enumerate}
$R \in \setR^+$ has stationary degree $d \in \N^+$ wr.t. $\setR^+$
if and only if
$R \in \setR^+$ has stationary degree $d \in \N^+$ wr.t. $\vec{C}, \setR^+$
for some$\vec{C}$.
\end{definition}
...
$V_{i-1}$ is stationary from $\dom(V_{i-1})$ to $\dom(U'_{i})$}.
...
\begin{proof}
Suppose $\setR^+$ is injective, $\vec{R}$ is a sequence on $\setR^+$ and
$\minStable(\vec{R}) = \vec{S} = S_1, \ldots, S_n$. Let $\tau = \trans(\sigma,R) $.
Let $S_{a_i}, \ldots, S_{b_i}$ for $i \in [1,h]$ be the components of $\vec{S}$,
$\sigma = (U_1, d_1,V_1; \ldots; U_h, d_h, V_h) \state \vec{R}$
with $U_i = S_{a_i}, \ldots, S_{n}$ and $V_i = S_{b_i}$. Suppose
...
$ the product of $vec{S},R$, and $\trans(\sigma,R) = (U'_1, 0, U'_0)$.
From $\dom(U'_1) \subset \dom(U_1)$ we deduce $\size(U'_1) < \size(U_1)$,
hence $\sigma > \trans(\sigma,R)$. $(U'_1, 0, U'_0) = (S_1 \ldots S_n,0,S_1 \ldots S_n)$ 
...
Suppose $i \in [2,h]$. Then $\dom(U'_i) \subset \dom(U_i)$
 ...
 $\DomCard(U'_i) > \DomCard(U'_{i-1})$, namely $S_{b_i} \ldots S_n R$
 is a component of $\vec{R},R$ and $\tau \state \vec{R},R$. 
...
Suppose $i=h+1$. Then $\dom(U'_{h+1}) \subset \dom(U_{h+1})$
 ...
 $\DomCard(R) = \DomCard(U'_{h+1}) > \DomCard(U'_{h})$, namely 
 $R = U_{h+1}$ is a component of $\vec{R},R$ and $\tau \state \vec{R},R$. 
...
Suppose $i \in [2,h]$. By assumption, $\dom(U'_i) \subset \dom(U_i)$
 ...
 is a component of $\vec{R},R$ with last element $(S_{a_i} \ldots S_n R)$. 
 $1$ is a degree of the product of  
 $S_{a_{i-1}}, \ldots, S_{b_{i-1}}, (S_{a_i} \ldots S_n R)$,
 therefore $\tau \state \vec{R},R$.
 $V_{i-1}$ is progressing from $\dom(V_{i-1})$ to $\dom(U'_{i})$, we
 deduce that $\size(U_{i-1}) = \size(V_{i-1}) > \size(U'_{i-1})$. Thus, $\sigma > \tau$.
 ...
 $S_{a_h}, \ldots, S_{b_h}, R$,
 therefore $\tau \state \vec{R},R$.
 $V_{h}$ is progressing from $\dom(V_{h})$ to $\dom(U'_{h+1})$, we
 deduce that $\size(U_{h}) = \size(V_{h}) > \size(U'_{h+1})$. Thus, $\sigma > \tau$.
...
If $i \in [2,h]$ then $S_{a_{i-1}}, \ldots, S_{b_{i-1}}, (S_{a_i} \ldots S_n R)$
 ...
 Then $d_{i-1}+1$ 
 is a degree of $U'_{i-1}$ and $\tau \state \vec{R},R$ and $d_{i-1}+1$ is a degree of
 $U'_{i-1}$ and $\sigma > \tau$.
 
 If $i = h+1$ then $S_{a_{h}}, \ldots, S_{b_{h}}, R$
 is the last component of $\vec{R},R$ with last element 
 $R$. Then $d_{i-1}+1$ 
 is a degree of $U'_{i-1}$ and $\tau \state \vec{R},R$ and $d_{i-1}+1$ is a degree of
 $U'_{i-1}$ and $\sigma > \tau$.
\end{enumerate}
