...
Assume $R,S$ is a constant-cardinality domain sequence 
...
(S_{a_1} \ldots S_m  R) = U'_1$, a grouping made of a single product, 
...
Suppose $i \in [2,h]$. Then $\dom(U'_i) \subset \dom(U_i)$
 ...
 $\DomCard(U'_i) > \DomCard(U'_{i-1})$, namely $\DomCard(S_{a_i} \ldots S_m R)
 > \DomCard(S_{a_{i-1}} \ldots S_m  R) = $ 
 (by stability and 
 Lemma \ref{lemma-domain-stability}.\ref{lemma-domain-stability-02}) 
 $ \DomCard(S_{a_{i-1}} \ldots S_{b_{i-1}}$.
 Thus $(S_{b_i} \ldots S_m R)$
...
Suppose $i \in [2,h]$. By assumption, $\dom(U'_i) \subset \dom(U_i)$
 ...
 $S_{a_{i-1}}, \ldots, S_{b_{i-1}}, (S_{a_i} \ldots S_m R)$
