...
if and only if there is some $\vec{C}= S_1, \ldots, S_e, R_1, \ldots, R_d$
with stationary degree $d$ wr.t. $\setR^+$ and such that
$R =  S_1 \ldots S_e R_1 \ldots R_d$, namely, $R$ is the product of $\vec{C}$
\end{definition}
...
The stationary degree measure an obstacle for having an infinitely progressing path.
