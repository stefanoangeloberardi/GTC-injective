...
There is a decreasing embedding $W$ from the value flows on $\setR, \setG$ with 
...
%13:44 03/03/2025
Assume $\setR$ is composition-closed in $\setG$.
...
that Neil Jones proved the equivalence of SCT and GTC with only
