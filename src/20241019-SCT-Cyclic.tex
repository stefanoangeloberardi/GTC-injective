...
from cyclic proofs. The paper \cite{2001-SCT}
uses for the same concepts the words: \quotationMarks{thread}
...
The terminology of cite{2001-SCT} is probably more suitable when speaking
of programs, while Brotherston and Simpson terminology,
trace and path, appears more suitable when speaking of a 
